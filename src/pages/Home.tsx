  ...
  return (
    <div className="font-inter">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600">Your health is our priority. We offer the best care.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((feature) => (
              <Card key={feature.id} className="text-center hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  <feature.icon className={`w-12 h-12 mx-auto mb-4 ${feature.iconColor || 'text-primary'}`} />
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary">Our Specialties</h2>
            <p className="mt-4 text-lg text-gray-600">A wide range of medical specialties under one roof.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {specialties.map((specialty) => (
              <div key={specialty.id} className="group relative overflow-hidden rounded-lg">
                <img src={specialty.image} alt={specialty.name} className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-300" />
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                  <h3 className="text-white text-xl font-bold text-center px-2">{specialty.name}</h3>
                </div>
              </div>
            ))}
          </div>
