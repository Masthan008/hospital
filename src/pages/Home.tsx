      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Why Choose Sri Ananth Hospital?</h2>
            <div className="w-24 h-1 bg-hospital-red mx-auto mb-6"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, index) => (
              <div 
                key={item.id}
                className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col"
                data-aos="fade-up"
                ...
                <div className="h-48 overflow-hidden relative bg-hospital-light-blue">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        const iconContainer = parent.querySelector('.icon-fallback');
                        if (iconContainer) {
